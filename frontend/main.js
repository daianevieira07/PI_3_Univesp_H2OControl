document.addEventListener("DOMContentLoaded", function () {
  ...
  const isAuthenticated = localStorage.getItem("h2ocontrol_authenticated") === "true";
  ...
  if (userElement) {
    const userData = JSON.parse(localStorage.getItem("h2ocontrol_user") || "{}");
    userElement.textContent = `Bem-vindo, ${userData.nome || "Usuário"}!`;
